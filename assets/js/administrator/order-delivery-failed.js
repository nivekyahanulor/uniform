    ...
    var url   =  urllink + '/process-table-admin-order-delivery-failed';
    var table = $('#table_orders_delivery_failed').DataTable({
        dom: 'Bfrtip',
        buttons: [ {
            extend: "csv",
    ...
    $('#table_orders_delivery_failed tbody').on( 'click', 'button', function () {
