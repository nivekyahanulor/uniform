   ...
   $('#cityDropdown').change(function() {
    ...
    $('#add-sender-address-book').submit(function(e) {
       ...
       setTimeout(function() {
           $.ajax({
               type: "POST",
               url: urllink + '/process-recipient-address-book',
               data: {
    ...
    $('#btn-cancel').click(function(e) {
        e.preventDefault();
        window.location.href = "address-book-recipient";
    });
   
   
    //**RECIPIENT ADDRESS BOOK  TABLE DATA **//
    
      $(document).ready(function () {
        var url   =  urllink + '/process-table-recipient-address-book';
